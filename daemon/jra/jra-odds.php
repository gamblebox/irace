...
function insert_qe_odds($html, $race, $type, $ktype)
{
  ...
  if (count($data)) {
    $sql = "REPLACE INTO `jra_odds` (`race_id_type`,`race_id`, `type`, `data`)  VALUES ('" . $race_id_type . "','" . $race_id . "','" . $ktype . "','" . json_encode($data, JSON_UNESCAPED_UNICODE) . "')";
    echo $sql . PHP_EOL;
...
function insert_wp_odds($html, $race)
{
  ...
  if (count($data_dan)) {
    ...
    $sql = "REPLACE INTO `jra_odds` (`race_id_type`,`race_id`, `type`, `data`)  VALUES ('" . $race_id_type . "','" . $race->id . "','확정단승','" . json_encode($data_dan, JSON_UNESCAPED_UNICODE) . "')";
    echo $sql . PHP_EOL;
    $ok = exec_query($database, $sql);
    echo $ok . PHP_EOL;
  }
  ...
  if (count($data_yun)) {
    ...
    $sql = "REPLACE INTO `jra_odds` (`race_id_type`,`race_id`, `type`, `data`)  VALUES ('" . $race_id_type . "','" . $race->id . "','확정연승','" . json_encode($data_yun, JSON_UNESCAPED_UNICODE) . "')";
    echo $sql . PHP_EOL;
    $ok = exec_query($database, $sql);
    echo $ok . PHP_EOL;
  }
  if (count($data_t_dan)) {
    ...
    $sql = "REPLACE INTO `jra_odds` (`race_id_type`,`race_id`, `type`, `data`)  VALUES ('" . $race_id_type . "','" . $race->id . "','단승','" . json_encode($data_t_dan, JSON_UNESCAPED_UNICODE) . "')";
    echo $sql . PHP_EOL;
    $ok = exec_query($database, $sql);
    echo $ok . PHP_EOL;
  }
  ...
  if (count($data_t_yun)) {
    ...
    $sql = "REPLACE INTO `jra_odds` (`race_id_type`,`race_id`, `type`, `data`)  VALUES ('" . $race_id_type . "','" . $race->id . "','연승','" . json_encode($data_t_yun, JSON_UNESCAPED_UNICODE) . "')";
    echo $sql . PHP_EOL;
    $ok = exec_query($database, $sql);
    echo $ok . PHP_EOL;
  }
...
function get_race_all_odds($database, $race)
{
  print_r($race);
  ...
  foreach ($lis as $key => $li) {
    ...
    $sql = "REPLACE INTO `jra_odds` (`race_id_type`,`race_id`, `type`, `data`)  VALUES ('" . $race_id_type . "','" . $race->id . "','" . $ktype . "','" . $odds_div . "')";
    // echo $sql . PHP_EOL;
    $ok = exec_query($database, $sql);
    echo $ok . PHP_EOL;
    // exit();
...
if ($races) {
  foreach ($races as $race) {
    get_race_all_odds($database, $race);
  }
