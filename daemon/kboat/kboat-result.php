...
function get_race_data_to_json($url)
{
  ...
  $dateTxt = trim($dom->find('.cptSection')[0]->findOne('.excel_table caption')->textContent);
  print_r($dateTxt);
  // exit();

  $date = mb_substr($dateTxt, 0, 4) . '-' . mb_substr($dateTxt, -13, 2) . '-' . mb_substr($dateTxt, -9, 2);
...
// $alinks = ['https://www.kcycle.or.kr/contents/information/raceResultPage.do?stndYear=2016&tms=17&dayOrd=2'];
