...
//echo $place_3;
if ($club_id == 255) {
	$sql = "select *, p.name as place_name , o.stat from `order` as o left outer join `race` as r on r.id=o.race_id  left outer join `user_info` as u on u.user_id=o.user_id left outer join `place` as p on p.id=r.place_id where o.`type` = '" . $type . "' and o.`race_id` = " . $race_id .  " and o.`place_1` = " . $place_1 .  " and o.`place_2` = " . $place_2 .  " and o.`place_3` = " . $place_3 .  " and u.club_id !=  " . $club_id;
} else {
	$sql = "select *, p.name as place_name , o.stat from `order` as o left outer join `race` as r on r.id=o.race_id  left outer join `user_info` as u on u.user_id=o.user_id left outer join `place` as p on p.id=r.place_id where o.`type` = '" . $type . "' and o.`race_id` = " . $race_id .  " and o.`place_1` = " . $place_1 .  " and o.`place_2` = " . $place_2 .  " and o.`place_3` = " . $place_3 .  " and u.club_id = " . $club_id;
}
//echo $sql;
