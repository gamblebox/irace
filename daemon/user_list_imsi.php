...
$editor = Editor::inst( $db, 'user_info' )->fields(
	...
	Field::inst( 'u_korea_race_ticketing_type' )->getFormatter( 'Format::explode', ',' )->setFormatter( 'Format::implode', ',' ),
	Field::inst( 'u_japan_race_ticketing_type' )->getFormatter( 'Format::explode', ',' )->setFormatter( 'Format::implode', ',' ),
	Field::inst( 'u_cycle_race_ticketing_type' )->getFormatter( 'Format::explode', ',' )->setFormatter( 'Format::implode', ',' ),
	Field::inst( 'u_boat_race_ticketing_type' )->getFormatter( 'Format::explode', ',' )->setFormatter( 'Format::implode', ',' ),
	Field::inst( 'u_ticketing_association' )->getFormatter( 'Format::explode', ',' )->setFormatter( 'Format::implode', ',' ),
	...
	Field::inst( 'u_japanrace_finish_time_offset' ),
	Field::inst( 'finish_time_offset_config' ),
	Field::inst( 'result_money_offset' ),
	Field::inst( 'korea_race_result_money_offset' ),
	Field::inst( 'japan_race_result_money_offset' ),
	Field::inst( 'user_pw' )
)
