...
$tomorrow = date('Ymd', strtotime(date(Ymd) . '+' . '0' . ' days')); // 1일 후                                                                     
