...
function get_race_data_to_json($url)
{
  ...
  // $url = 'https://141.164.48.95/curl.php?url=' . urlencode($url);
...
$alinks = [
  'https://www.kcycle.or.kr/contents/information/raceResultPage.do'
];
// $alinks = ['https://www.kcycle.or.kr/contents/information/raceResultPage.do?stndYear=2020&tms_dayOrd=45-3'];
