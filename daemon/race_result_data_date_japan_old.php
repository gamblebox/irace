...
function get_race_data_to_json($url)
{
    global $data;
    //print_r($url);
    //$url='http://www2.keiba.go.jp/KeibaWeb/TodayRaceInfo/RaceList?k_babaCode=23&k_raceDate=2016/12/28';
    ...
    //echo $date;
    //*[@id="container00"]/table/tbody/tr[2]/td/table/tbody/tr/td/table[2]/tbody/tr/td/table[1]/tbody/tr[4]/td[20]/span/a
    ...
    //*[@id="container00"]/table/tbody/tr[2]/td/table/tbody/tr/td/table[2]/tbody/tr/td/table[1]/tbody/tr[4]/td[20]/span/a
    //$link = $xpath->query( '//*[@id="container00"]/table//tr[2]/td/table//tr/td/table[2]//tr/td/table[1]//tr[4]/td[last()]/span/a/@href' );
    //*[@id="container00"]/table/tbody/tr[2]/td/table/tbody/tr/td/article[1]/table/tbody/tr[7]/td[21]
    //http://www2.keiba.go.jp/KeibaWeb/TodayRaceInfo/RaceList?k_raceDate=2018%2f01%2f23&k_babaCode=23
    //http://www2.keiba.go.jp/KeibaWeb/TodayRaceInfo/RefundMoneyList?k_raceDate=2018%2f01%2f23&k_babaCode=23
    $link = $xpath->query('//*[@id="container00"]//*[@class="dbnote"][1]/td[last()]/span/a/@href');
    //*[@id="container00"]/table/tbody/tr[2]/td/table/tbody/tr/td/article[1]/table/tbody/tr[4]/td[21]/span/a
    //*[@id="container00"]/table/tbody/tr[2]/td/table/tbody/tr/td/article[1]/table/tbody/tr[4]/td[21]/span/a
    //print_r($link);
    //print_r($link[0]->value);
    //$url = 'http://www2.keiba.go.jp/KeibaWeb/TodayRaceInfo/RefundMoneyList?k_raceDate=' . $link_date . '&k_babaCode=' . $place_own_id;

    //$alinks = $xpath->query( '//*[@id="mainContainer"]/article[1]/div/table/tbody/tr[2]/td[3]/a/@href' );
    //*[@id="mainContainer"]/article[1]/div/section/table[1]/tbody/tr[3]/td[10]/a[3]
    $links = $xpath->query('//*[@id="mainContainer"]/article[1]/div/section/table[1]/tbody/tr/td[10]/a[last()]/@href');
    print_r($links);
    foreach ($links as $link) {
        //print_r($alink);
        $url = 'http://www2.keiba.go.jp/KeibaWeb' . substr($link->value, 2);
        echo $url . PHP_EOL;

        //$url = 'http://www2.keiba.go.jp/KeibaWeb/TodayRaceInfo/RaceMarkTable?k_raceDate=' . $link_date . '&k_raceNo=' . $c . '&k_babaCode=' . $place_own_id;
        //http://www2.keiba.go.jp/KeibaWeb/TodayRaceInfo/RaceMarkTable?k_raceDate=2018%2f06%2f01&k_raceNo=1&k_babaCode=23

        //echo $url . PHP_EOL;
        //$url = 'http://www2.keiba.go.jp' . $link[ 0 ]->value;
        //echo 'hi ';
        //print_r($url);
        //print_r($link[0]->value);
        //$dom = new DomDocument;
        ...
        $headerNames = ['own_id', 'start_date', 'race_no', '단승', '연승', '복승', '쌍승', '복연승', '삼복승', '삼쌍승'];
...
$xpath = new DomXPath($dom);
//*[@id="mainContainer"]/article[2]/div/table/tbody/tr[2]/td[3]
//*[@id="mainContainer"]/article[1]/div/table/tbody/tr[2]/td[3]
//$alinks = $xpath->query( '//*[@id="mainContainer"]/article[@class="courseInfo"]/div/table/tbody/tr[2]/td[3]/a/@href' );
$alinks = $xpath->query('//*[@id="mainContainer"]/article[1]/div/table/tbody/tr[2]/td[3]/a/@href');

////*[@id="mainContainer"]/article[1]/div/table/tbody/tr[2]/td[3]/a[2]
...
foreach ($data as $i => $r) {
    ...
    $rmsg = [$own_id, $start_date, $race_no, $ok];
