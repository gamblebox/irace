...
Editor::inst($db, 'banking')->fields(Field::inst('banking.banking_type'), Field::inst( 'user_info.user_level' ), Field::inst( 'partner_info.club_user_id' ),
...
}), Field::inst('user_info.nick_name'), Field::inst('user_info.club_user_id'), Field::inst('user_info.user_id'), Field::inst('user_info.partner_id'), Field::inst('user_info.money_real'), Field::inst('user_info.money_service'), 
Field::inst('banking.amount'), Field::inst('banking.bank_name'), Field::inst('banking.bank_account_no'), Field::inst('banking.bank_account_name'), Field::inst('banking.r_time'), Field::inst('banking.u_time'), Field::inst('banking.stat'), Field::inst('banking.isfirst'))
